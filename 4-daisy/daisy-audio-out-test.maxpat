...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 448.0, 443.0, 59.0, 23.0 ],
									"text" : "cycle 330"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 315.0, 436.0, 59.0, 23.0 ],
									"text" : "cycle 440"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 461.0, 386.0, 59.0, 23.0 ],
									"text" : "cycle 330"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 250.0, 372.0, 59.0, 23.0 ],
									"text" : "cycle 440"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 562.0, 146.0, 61.0, 23.0 ],
									"text" : "counter 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 562.0, 188.0, 267.0, 153.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 810.0, 36.0, 105.0, 37.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 472.0, 133.0, 75.0, 35.0 ],
									"presentation_linecount" : 2,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 592.0, 87.0, 101.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 562.0, 87.0, 28.0, 23.0 ],
									"text" : "!/ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 562.0, 36.0, 156.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 612.5, 428.0, 83.0, 21.0 ],
									"text" : "apply to input"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 562.0, 462.0, 36.0, 23.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 562.0, 428.0, 46.0, 23.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 380.0, 46.0, 23.0 ],
									"text" : "*"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 571.5, 415.0, 571.5, 415.0 ],
									"source" : [ "obj-17", 0 ]
								}
...
,
					...
					"saved_object_attributes" : 					{
						...
						"exportname" : "daisy_2daudio_2dout_2dtest"
					}
,
					"text" : "gen~",
					"varname" : "daisy_2daudio_2dout_2dtest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 366.0, 24.0, 128.0, 128.0 ],
					"viewvisibility" : 1
				}
